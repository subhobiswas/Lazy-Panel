<?php
//{"lang":"","fm_root":"C:\xamp\htdocs\billing2\","timezone":"","date_format":"Y\/m\/d H:i","auth_pass":"e7388bf13b7affa5bd5cc8ddd871d816","error_reporting":"0"}
$version = '1.7.9';
$charset = 'UTF-8';
$debug_mode = false;
...
class config {
    ...
    function __construct(){
        $this->data = array(
            'lang'=>'en',
            'fm_root'=>'C:/xamp/htdocs/dharmender/',
            'timezone'=>'',
...
function frame2(){
    ...
    ?>
        ...
        <style>
            #tree .jstree-ocl{height: 25px;width: 25px;}
...
function dir_list_form() {
            ...
            foreach ($entry_list as $ind=>$dir_entry) {
                ...
                if ($dir_entry['type'] == "dir") {
                    ...
                    if ( is_writable($fm_current_dir.$file) ) $dir_out[$dir_count][] = "
                        <td align=center class=\"sm\"><a class=\"btn btn-danger\" onmousedown=\"if(event)event.stopPropagation();\" href=\"javascript:delete_entry('".addslashes($file)."')\">".et('Rem')."</a></td>";
                    else $dir_out[$dir_count][] = "<td class=\"sm\">&nbsp;</td>";
                    if ( is_writable($fm_current_dir.$file) ) $dir_out[$dir_count][] = "
                        <td align=center class=\"sm\"><a class=\"btn btn-primary\" onmousedown=\"if(event)event.stopPropagation();\" href=\"Javascript:rename_entry('".addslashes($file)."')\">".et('Ren')."</a></td>";
                    else $dir_out[$dir_count][] = "<td class=\"sm\">&nbsp;</td>";
                    ...
                    if ( is_readable($fm_current_dir.$file) ) $file_out[$file_count][] = "
                                <td align=center class=\"sm\"><a class=\"btn btn-success\" onmousedown=\"if(event)event.stopPropagation();\" href=\"javascript:edit_file_form('".addslashes($file)."')\">".et('Edit')."</a></td>";
                    else $file_out[$file_count][] = "<td class=\"sm\">&nbsp;</td>";
    ...
    $out .= "
    <link rel=\"stylesheet\" href=\"lazy_fm_style.css\">
    <script language=\"Javascript\" type=\"text/javascript\">
    <!--
        update_footer_status();
...
function edit_file_form(){
    ...
    echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"".$fm_path_info['basename']."?action=99&filename=prism.css\" media=\"screen\" />";
    html_header("
